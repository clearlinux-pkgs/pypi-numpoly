...
Source0  : https://files.pythonhosted.org/packages/97/eb/644da94dc4c7850a7f5f7697dea4a759087d4aab4e3dc85c4ba9db097737/numpoly-1.2.12.tar.gz
...
%prep
%setup -q -n numpoly-1.2.12
cd %{_builddir}/numpoly-1.2.12
pushd ..
cp -a numpoly-1.2.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716090383
